...
class ITunes(Automation, RSS):
    ...
    def getIMDBids(self):
        ...
        for index, url in enumerate(urls):
            if not is_list_item_enabled(enablers, index):
                continue
    ...
    'groups': [
        {
            ...
            'label': 'iTunes',
            'description': 'From any <a href="https://itunes.apple.com/rss" target="_blank">iTunes</a> Store feed. Url should be the RSS link.',
            'options': [
                {
