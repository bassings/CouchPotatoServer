...
MA.Trailer = new Class({
    ...
    watch: function() {
        ...
        var iframe = new Element("iframe", {
            src: "https://www.youtube.com/embed/" + self.video_id + "?rel=0&autoplay=1&iv_load_policy=3&vq=hd720",
        ...
        iframe.addEventListener("load", function() {
            try {
                ...
                if (iframeDoc && iframeDoc.querySelector(".ytp-error")) {
                    window.open("https://www.youtube.com/watch?v=" + self.video_id, "_blank");
                }
            } catch(e) {}
        });
        iframe.inject(self.container);
        self.container.adopt(new Element("a.trailer_fallback[href=https://www.youtube.com/watch?v=" + self.video_id + "][target=_blank][text=Open on YouTube]"));
    }
});
