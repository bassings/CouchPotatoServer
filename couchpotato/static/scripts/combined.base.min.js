...
var CouchPotato = new Class({
    ...
    createLayout: function() {
        ...
        self.c.adopt($(self.block.header).addClass("header").adopt(self.block.navigation = new BlockHeader(self, {}), self.block.search = new BlockSearch(self, {}), self.support = new Element("a.icon-donate", {
    ...
    createUserscriptButtons: function() {
        return new Element("div.group_userscript").adopt(new Element("div").adopt(new Element("span", {
