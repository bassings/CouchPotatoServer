...
var CouchPotato = new Class({
    ...
    createLayout: function() {
        ...
        self.c.adopt($(self.block.header).addClass("header").adopt(self.block.navigation = new BlockHeader(self, {}), self.block.search = new BlockSearch(self, {}), self.support = new Element("a.donate", {
